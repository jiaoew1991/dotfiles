...
local mappings = {
  ...
  ["e"] = { "<cmd>Neotree toggle=true action=show reveal<cr>", "Explorer" },
  ["w"] = { "<cmd>w!<CR>", "Save" },
  ["q"] = { "<cmd>q!<CR>", "Quit" },
  ...
  ["z"] = { "<cmd>WindowsMaximize<cr>", "Toggle Maximize" },
  b = {
    name = "Buffer",
    f = {
    ...
    e = { "<cmd>Neotree buffers<cr>", "Buffers" },
  },
  p = {
    name = "Packer",
  ...
  l = {
    ...
    h = { "<cmd>Lspsaga incoming_calls<cr>", "Incoming Hierarchy" },
    H = { "<cmd>Lspsaga outgoing_calls<cr>", "Outgoing Hierarchy" },
  },
  s = {
    name = "Search",
    b = { "<cmd>Telescope git_branches<cr>", "Checkout branch" },
    ...
    w = { "<cmd>HopWord<cr>", "Go to word" },
    l = { "<cmd>HopLine<cr>", "Go to line" },
  },
  t = {
    name = "Terminal",
